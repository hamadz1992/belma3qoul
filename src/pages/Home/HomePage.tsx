  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-transparent pb-3">
      ...
      <div className="relative z-10">
        <section id="home" className="border-b border-rose-100/60 bg-transparent">
          <div className="mx-auto w-full max-w-7xl px-4 py-5 sm:px-6 lg:px-8 lg:py-7">
            <div className="overflow-hidden rounded-[2rem] border border-white bg-white shadow-xl shadow-slate-300/20">
              <img src={heroBanner} alt={siteSettings.name} className="h-[190px] w-full object-cover object-center sm:h-[270px] lg:h-[350px]" />
            </div>
          </div>
        </section>
