          ...
          <article className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <div className="mt-6 space-y-3">
              {[
                {
                  platform: 'facebook',
                  label: 'Facebook',
                  hint: 'صفحتنا على Facebook',
                  href: socialSettings.facebook,
                },
                {
                  platform: 'instagram',
                  label: 'Instagram',
                  hint: 'تابعنا على Instagram',
                  href: socialSettings.instagram,
                },
                {
                  platform: 'tiktok',
                  label: 'TikTok',
                  hint: 'تابعنا على TikTok',
                  href: socialSettings.tiktok,
                },
                {
                  platform: 'telegram',
                  label: 'Telegram',
                  hint: 'قناتنا على Telegram',
                  href: socialSettings.telegram,
                },
                {
                  platform: 'youtube',
                  label: 'YouTube',
                  hint: 'قناتنا على YouTube',
              ...
              {!Object.values(socialSettings).some((value) => value.trim()) ? (
                <div className="rounded-[1.3rem] border border-dashed border-slate-200 bg-slate-50 p-5 text-center text-sm text-slate-500">
                  أضف روابط الشبكات الاجتماعية من لوحة التحكم لتظهر هنا.
                </div>
              ) : null}
            </div>
          </article>
          ...
          <div className="grid gap-6 xl:grid-cols-[1.15fr_1.25fr_1fr]">
            <article className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
              <SectionHeading
                ...
                title={`جديد في ${siteSettings.name}`}
                description=""
                descriptionClassName="text-sm leading-6"
              />
              ...
              <div className="mt-6 space-y-4 text-right">
                ...
                <div className="flex flex-wrap gap-3 pt-1">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="rounded-full bg-[#1877F2] px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-[#166FE5]"
                  >
                    Facebook
                  </a>
